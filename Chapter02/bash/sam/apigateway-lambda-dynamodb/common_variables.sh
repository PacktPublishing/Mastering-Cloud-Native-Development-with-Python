...
#export TEMPLATE="lambda-dynamo-data-api-aws-policy-sam"
#export TEMPLATE="lambda-dynamo-data-api-custom-policy-sam"
export TEMPLATE="lambda-dynamo-data-api-custom-role-sam"
#export TEMPLATE="lambda-dynamo-data-api-inline-policy-sam"
